...
extension ServiceAPI: TargetType {
    ...
    var baseURL: URL {
        guard let url = URL(string: "http://18.222.80.47:8080/trungapi" ) else {
    ...
    var headers: [String: String]? {
        ...
        case .bookingPitch, .getResever, .cancelResever:
            var headers: [String: String] = [:]
            headers["authorization"] = "eyJhbGciOiJIUzI1NiJ9.eyJwaG9uZSI6IjAxMjM0NTY3ODkiLCJleHAiOjE2MDI4MTMwMTJ9.mKmyEe7U70dmj2Z2QWGldtpUwccD42Km7k2M5HZgEqA"
            return headers
        default:
            var headers: [String: String] = [:]
